...
#define FIFO_PATH "/tmp/volume_bar_classic.fifo"
#define ICON_MUTE "󰝟"
#define ICON_LOW  "󰕿"
#define ICON_MID  "󰖀"
#define ICON_HIGH "󰕾"
...
int main(int argc, char *argv[]) {
    ...
    gtk_css_provider_load_from_data(provider,
        ...
        "trough { background-color: rgba(69, 71, 90, 0.5); border-radius: 10px; min-height: 24px; } "
        "progress { background-image: linear-gradient(to right, #cba6f7, #89b4fa); border-radius: 10px; transition: all 0.2s cubic-bezier(0.16, 1, 0.3, 1); } ", -1, NULL);
