...
int main(int argc, char *argv[]) {
    ...
    gtk_layer_set_namespace(GTK_WINDOW(osd->window), "volume-osd-dracula");
    ...
    gtk_css_provider_load_from_data(provider,
        ...
        "progress { background-color: #bd93f9; border-radius: 16px; min-height: 32px; transition: all 0.05s cubic-bezier(0.16, 1, 0.3, 1); } ", -1, NULL);
